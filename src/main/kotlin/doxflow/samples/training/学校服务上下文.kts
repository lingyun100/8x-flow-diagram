...
diagram_8x_flow {
    ...
    context("学校服务上下文") {
        ...
        val student = participant_party("学生")
        val someTeacher = participant_party("某某讲师")
        val someResourceProvider = participant_party("某某供应商")
...
//        val teacher = role_party("讲师")
        ...
        val joinCourse = role_domain("讲师授课与学生听课服务")
...
//        someTeacher play teacher
        ...
        student play joinCourse
        someTeacher play joinCourse
        ...
        rfp("采购课程", courseBuyer, ONE_TO_N) {
            ...
            proposal("提交提案", platform, ONE_TO_N) {
                ...
                contract("学校服务合同", courseBuyer, platform, courseUser, resourceProvider,joinCourse) {
                    key_timestamps("签订时间")
                    ...
                    grantAccess = fulfillment("开通学生学之道使用权限", ONE_TO_N) {
                        request(courseBuyer) {
                            key_timestamps("创建时间", "过期时间")
                        }
                    ...
                    viewCourses = fulfillment("查看课程", ONE_TO_N) {
                        request(courseUser) {
                            key_timestamps("创建时间")
                        }
...
} export "./diagrams/training/学校服务上下文.png"